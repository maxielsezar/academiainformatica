      ...
      <section>
        ...
        <div className="border p-6 rounded-xl">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Título del trabajo centrado y en negrita.</li>
...
<section>
  ...
  <div className="space-y-6">
    ...
    <div className="border p-6 rounded-xl">
      ...
      Dentro de la sección de hardware, crear una tabla que incluya
      <strong> componentes internos</strong> de la computadora.
      La tabla debe contener el nombre del componente y una breve
      descripción de su función.
    </div>

    <div className="border p-6 rounded-xl">
      <p className="font-semibold mb-2">Actividad 5</p>
      Crear una tabla de <strong>periféricos de entrada</strong>.
      Cada elemento debe incluir una breve descripción.
    </div>

    <div className="border p-6 rounded-xl">
      <p className="font-semibold mb-2">Actividad 6</p>
      Crear una tabla de <strong>periféricos de salida</strong>.
    ...
    <div className="border p-6 rounded-xl">
      ...
      Crear una tabla con ejemplos de <strong>sistemas operativos </strong>
    ...
    <div className="border p-6 rounded-xl">
      ...
      Crear una tabla con ejemplos de <strong>procesadores de texto </strong>
