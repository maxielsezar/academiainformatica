...
export const metadata = {
  ...
  description:
    "Curso de Formación Profesional en Operador de Informática para Administración y Gestión.",
};

export default function CursoAdministracionPage() {
  const cursoData = cursos.administracion;
